...
def update_theme():
    with open('emosense_full_app.html', 'r', encoding='utf-8') as f:
        content = f.read()
    ...
    content = content.replace('rgba(15, 15, 26', 'rgba(255, 255, 255')
    ...
    with open('emosense_full_app.html', 'w', encoding='utf-8') as f:
        f.write(content)
